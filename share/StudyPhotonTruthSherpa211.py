...
#filelist = ['/r03/atlas/khoo/Data_2014/DAOD_TRUTH/mc12_13TeV.177583.Sherpa_CT10_SinglePhotonMassiveCBPt140_280_BFilter.merge.DAOD_TRUTH1.e3083_p2321_tid05193453_00/DAOD_TRUTH1.05193453._000008.pool.root.1']
    ...
    fileName   = 'PhotonTruth.' + path.basename(filelist[0].split(".")[2]) + '.root'
...
# Set up default configurations
    ...
    topSequence += CfgMgr.PhotonTruthAlg("Gamma_35_70" + path.basename(filelist[0]).replace(".", ""),
                                         RootStreamName=streamName,
                                         RootDirName='/GammaPt35',
                                         PhotonRef_PtMin=   35e3,
                                         PhotonRef_PtMax=   70e3,
                                         JetRJCut       = 20)
    topSequence += CfgMgr.PhotonTruthAlg("Gamma_70_140" + path.basename(filelist[0]).replace(".", ""),
                                         RootStreamName=streamName,
                                         RootDirName='/GammaPt70',
                                         PhotonRef_PtMin=  70e3,PhotonRef_PtMax=  140e3,
                                         JetRJCut       = 20)
    topSequence += CfgMgr.PhotonTruthAlg("Gamma_140_280" + path.basename(filelist[0]).replace(".", ""),
                                         RootStreamName=streamName,
    ...
    topSequence += CfgMgr.PhotonTruthAlg("Gamma_280_500" + path.basename(filelist[0]).replace(".", ""),
                                         RootStreamName=streamName,
                                         RootDirName='/GammaPt280',
                                         PhotonRef_PtMin= 280e3,PhotonRef_PtMax= 500e3,
                                         JetRJCut       = 20)
    topSequence += CfgMgr.PhotonTruthAlg("Gamma_500_1000" + path.basename(filelist[0]).replace(".", ""),
                                         RootStreamName=streamName,
                                         RootDirName='/GammaPt500',
                                         PhotonRef_PtMin= 500e3,PhotonRef_PtMax= 1000e3,
                                         JetRJCut       = 20)
    topSequence += CfgMgr.PhotonTruthAlg("Gamma_1000_2000" + path.basename(filelist[0]).replace(".", ""),
                                         RootStreamName=streamName,
                                         RootDirName='/GammaPt1000',
                                         PhotonRef_PtMin=1000e3,PhotonRef_PtMax=2000e3,
                                         JetRJCut       = 20)
    topSequence += CfgMgr.PhotonTruthAlg("Gamma_2000_4000" + path.basename(filelist[0]).replace(".", ""),
                                         RootStreamName=streamName,
                                         RootDirName='/GammaPt2000',
                                         PhotonRef_PtMin=2000e3,PhotonRef_PtMax=4000e3,
                                         JetRJCut       = 20)
    topSequence += CfgMgr.PhotonTruthAlg("Gamma_4000_inf" + path.basename(filelist[0]).replace(".", ""),
                                         RootStreamName=streamName,
