...
def studyZbosonTruth(localFileList = None) :
    if localFileList == None :
#        localFileList = ['/data/users/rsmith/mc15_13TeV.407168.Sherpa_CT10_Znunu_LO_Pt70_140_BFilter.merge.DAOD_TRUTH1.e4105_p2375/DAOD_TRUTH1.05970499._000001.pool.root.1']
        localFileList = ['/data/users/rsmith/mc15_13TeV.361449.Sherpa_CT10_Znunu_Pt70_140_BFilter.merge.DAOD_TRUTH1.e3651_p2375/DAOD_TRUTH1.05969994._000001.pool.root.1']
#mc15_13TeV.361447.Sherpa_CT10_Znunu_Pt70_140_CVetoBVeto.merge.DAOD_TRUTH1.e3651_p2375/DAOD_TRUTH1.05969958._000001.pool.root.1']
#/data/users/rsmith/mc15_13TeV.407171.Sherpa_CT10_Znunu_LO_Pt140_280_BFilter.merge.DAOD_TRUTH1.e4105_p2375/DAOD_TRUTH1.05970514._000001.pool.root.1']

    print localFileList
#localFileList = ["/r03/atlas/khoo/Data_2014/DAOD_TRUTH/user.khoo.167820.Sherpa_CT10_ZnunuMassiveCBPt140_280_CVetoBVeto.DAOD_TRUTH.e2798.080415.v1_EXT0//user.khoo.5272457.EXT0._000014.DAOD_TRUTH1.test.pool.root"]
    ...
    fileName   = 'ZbosonTruth.' + path.basename(localFileList[0].split(".")[2]) + '.root'
...
#    from optparse import OptionParser
    ...
    # print "parsing"
    # parser = OptionParser()
    # parser.add_option("--localFileList"   , help="your datasets" , default="")
